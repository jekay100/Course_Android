package android.study.demo.multimedia;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonSimple.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				MediaPlayer mp = MediaPlayer.create(AudioHelloworld.this,
						android.study.demo.R.raw.maria);
				mp.start(); // no need to call prepare(); create() does that for
							// you
			}
		...
		// Notification: before this demo , please push one mp3 file into the
		// sdcard path
