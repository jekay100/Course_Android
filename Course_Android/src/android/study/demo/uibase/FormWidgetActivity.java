...
public class FormWidgetActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] db = new String[] { "helo", "sundy", "googd morning",
				"goode endfudf", "dfsddf", "todeath" };
	...
	private void showDatePicker() {
		...
		datePicker1.init(calendar.get(Calendar.YEAR) + 1,
				...
				new OnDateChangedListener() {
					...
					public void onDateChanged(DatePicker view, int year,
						...
						Toast.makeText(
								FormWidgetActivity.this,
								"Year:" + year + " Month:" + monthOfYear
										+ " Day:" + dayOfMonth, 3000).show();
					}
				});
	}
	...
	private void showAutoCompleteTextView() {
		...
		String[] countries = new String[] { "Afghanistan", "Albania",
				...
				"Rwanda", "Sqo Tome and Principe", "Saint Helena",
	...
	private void showRatingBar() {
		...
		ratingBar.setOnRatingBarChangeListener(new OnRatingBarChangeListener() {
			...
			public void onRatingChanged(RatingBar ratingBar, float rating,
					boolean fromUser) {
				// TODO Auto-generated method stub
				Toast.makeText(FormWidgetActivity.this, "Rate:" + rating, 3000)
						.show();
	...
	private void showSpinner() {
		Spinner spinner = (Spinner) findViewById(R.id.spinner1);
		// 建立数据源
		String[] myItemsStrings = getResources().getStringArray(
				R.array.spinnername);
		// 建立Adapter ， 连接了数据源
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_dropdown_item, myItemsStrings);
		// 绑定adapter 到UI组件
		...
		radioGroup
				.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					...
					public void onCheckedChanged(RadioGroup group, int checkedId) {
						...
						switch (checkedId) {
						case R.id.radio0:
							Toast.makeText(FormWidgetActivity.this,
									"RadioButton 1", 2000).show();
							break;
						case R.id.radio1:
							Toast.makeText(FormWidgetActivity.this,
									"RadioButton 2", 2000).show();
						case R.id.radio2:
							Toast.makeText(FormWidgetActivity.this,
									"RadioButton 3", 2000).show();
						default:
							break;
						}
					}
	...
	private void showTextView() {
		 ...
		 * 
		 * @Override public Drawable getDrawable(String source) { if(source !=
		 * null) { // TODO Auto-generated method stub BitmapDrawable
		 * returnDrawable =
		 * (BitmapDrawable)getResources().getDrawable(R.drawable.name) ;
		 * returnDrawable.setBounds(0, 0, returnDrawable.getIntrinsicWidth(),
		 * returnDrawable.getIntrinsicHeight()) ; return returnDrawable ; }else
		 * { return null ; }
		 * 
		 * } };
		 * 
		 ...
		 * 
		 * @Override public void handleTag(boolean opening, String tag, Editable
		 * output, XMLReader xmlReader) { // TODO Auto-generated method stub
		 * 
		...
		SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(
				"#大家好#，今天天气不错哦！");
		ImageSpan imageSpan = new ImageSpan(FormWidgetActivity.this,
				R.drawable.name);
		...
		spannableStringBuilder.setSpan(imageSpan, 4, 5,
				Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		spannableStringBuilder.setSpan(clickableSpan, 0, 4,
