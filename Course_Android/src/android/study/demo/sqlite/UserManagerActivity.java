package android.study.demo.sqlite;
...
public class UserManagerActivity extends ListActivity {
			...
			AlertDialog dialog = new AlertDialog.Builder(this)
					...
					.setView(
							LayoutInflater.from(this).inflate(
									R.layout.layout_adduser_dialog, null))
					.setPositiveButton("添加", new OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							...
							User _user = new User();
							EditText editUser = (EditText) dialog
									.findViewById(R.id.editTextUserName);
							EditText editAddress = (EditText) dialog
									.findViewById(R.id.editTextUserAddress);
							_user.setUserAge(18);
							_user.setMale(true);
							if (editUser != null)
							...
							if (editAddress != null)
								_user.setUserAddress(editAddress.getText()
										.toString());
							else {
	...
	private void displayUserList() {
		...
		SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,
				...
				dbOperation.queryUserAll(),
				new String[] { dbOperation.COLUMN_USERNAME,
						dbOperation.COLUMN_ADRESS }, new int[] {
