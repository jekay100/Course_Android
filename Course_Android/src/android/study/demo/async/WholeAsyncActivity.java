...
public class WholeAsyncActivity extends Activity {
	...
	class SundyAsyncTask extends AsyncTask<String, Integer, Drawable> {
		...
		protected Drawable doInBackground(String... params) {
			...
			try {
				drawable3 = Drawable.createFromStream(
						new URL(params[0]).openStream(), "image.gif");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				new SundyAsyncTask()
						.execute("http://img.mm-girl.com/photo/180/chenqiaoen-se-459180.jpg");
			}
		});
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (msg != null && msg.getData().containsKey("sundy")) {
					...
					Toast.makeText(WholeAsyncActivity.this,
							"接收到消息:" + megContent, 3000).show();
					...
					public void run() {
						...
						try {
							_drawable2 = Drawable
									.createFromStream(
											new URL(
													"http://www.nihaotw.com/18094/hylxyyc/mtjl/201003/W020100331473852181905.jpg")
													.openStream(), "image.gif");
						} catch (MalformedURLException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						} catch (IOException e) {
					...
					public void run() {
						...
						try {
							Drawable _drawable = Drawable
									.createFromStream(
											new URL(
													"http://img.mm-girl.com/photo/180/chenqiaoen-se-459180.jpg")
													.openStream(), "image.gif");
