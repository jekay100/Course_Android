package android.study.demo.broadcastreceiver;
...
public class MyBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context arg0, Intent arg1) {
		...
		if (arg1.getAction().equals("sundy.android.demo.HiMessage")) {
			...
			PendingIntent pi = PendingIntent.getActivity(arg0, 1233,
					new Intent(Intent.ACTION_DIAL, Uri.parse("tel:10086")), 0);
			// Notification设置最新事件信息
			notify.setLatestEventInfo(arg0, "接收到自定义消息!",
					arg1.getStringExtra("message"), pi);
			// 启动提醒
